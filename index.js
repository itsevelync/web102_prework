...
descriptionContainer.innerHTML += displayParagraph.innerHTML;
...
firstGameParagraph.innerHTML = game1.name;
firstGameContainer.appendChild(firstGameParagraph);

// do the same for the runner up item
const secondGameParagraph = document.createElement('p');
secondGameParagraph.innerHTML = game2.name;
secondGameContainer.appendChild(secondGameParagraph);

//BONUS FEATURE: Click the header to make it green

const header = document.getElementsByClassName("header");
header[0].addEventListener('click', ()=> {
    header[0].style.backgroundColor = header[0].style.backgroundColor == "rgb(154, 117, 168)" ? "rgb(117, 168, 146)" : "rgb(154, 117, 168)";
});

//BONUS FEATURE: See all games when the button is clicked

const seeGamesBtn = document.getElementById("see-games-btn");
seeGamesBtn.addEventListener('click', ()=> {
